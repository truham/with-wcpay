...
A React Native demo showing how to integrate [@walletconnect/pay](https://www.npmjs.com/package/@walletconnect/pay) with [@turnkey/react-native-wallet-kit](https://www.npmjs.com/package/@turnkey/react-native-wallet-kit) for gasless USDC payments. Turnkey handles embedded wallet creation and EIP-712 signing. WalletConnect Pay handles transaction construction, gas sponsorship via 7702 paymaster, and on-chain broadcast.
