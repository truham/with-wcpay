...
import { getWcPayClient, buildAccounts, normalizePaymentLink } from "@/constants/walletconnect";
    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        <View style={styles.webviewHeader}>
          ...
          >
            <Text style={[styles.webviewCancel, { color: colors.secondaryText }]}>
              Cancel
            </Text>
          </TouchableOpacity>
        </View>
        <WebView
          ...
          onMessage={(event) => {
            try {
              ...
              if (data.type === "IC_COMPLETE" || data.resultType === "IC_COMPLETE") {
                handleIcComplete();
              } else if (data.type === "IC_ERROR" || data.resultType === "IC_ERROR") {
          ...
          onShouldStartLoadWithRequest={(request) => {
            ...
            if (request.url.includes("pay.walletconnect.com") || request.url.includes("walletconnect.org")) {
              return true;
            }
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView contentContainerStyle={styles.optionsContainer}>
        ...
        {optionDisplay && (
          <Text
            style={[styles.amountSubtext, { color: colors.secondaryText }]}
          >
